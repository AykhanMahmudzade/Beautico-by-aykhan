    ...
    <div className="aboutUs text-center">
      ...
      <div className="productscus">
        <div className="row cartik">
          ...
          <div className="col-12 col-md-6 col-lg-4 carta1 mb-4">
          ...
          <div className="col-12 col-md-6 col-lg-4 carta2 mb-4">
            <div className="card border-0">
              <Card
          ...
          <div className="col-12 col-md-6 col-lg-4 carta3 mb-4">
            <div className="card border-0">
              <Card
