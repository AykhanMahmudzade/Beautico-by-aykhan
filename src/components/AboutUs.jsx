    ...
    return (
        <div className='container pt-5'>
          ...
          <div className="productscus">
            <div className="row cartik">
    
              <div className="col-12 col-md-6 col-lg-4 carta1 ">
                ...
                />
                 ...
                 <div className="col-12 col-md-6 col-lg-4 carta2  ">
                 <div className="card border-0">
                ...
                <div className="col-12 col-md-6 col-lg-4 carta3 ">
                <div className="card border-0">
